...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen w-full flex mt-16">
      <div 
        ...
        <div className="w-full max-w-md">
          ...
          {errors.api && (
            <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg">
              <p className="text-red-700 text-center">{errors.api}</p>
            </div>
          )}
              ...
              <div className="space-y-6">
                ...
                <div className="flex space-x-3">
                  <button
                    ...
                    onClick={() => setStep(1)}
                    disabled={loading}
                    className="w-1/3 px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors font-medium text-gray-700 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    Back
                  </button>
                  <button
                    ...
                    disabled={loading}
                    className="relative w-2/3 py-3 rounded-lg font-semibold text-lg overflow-hidden group border-2 border-green-600 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    <span className="absolute inset-0 w-0 bg-gradient-to-r from-green-600 to-emerald-600 transition-all duration-500 ease-out group-hover:w-full"></span>
                    <span className="relative text-green-600 group-hover:text-white transition-colors duration-300">
